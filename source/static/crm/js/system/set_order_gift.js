	...
	$("#js_save_og").click(function(e){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(obj.stat == "ok"){
					$("#js_save_og").attr('disable','disable');
					$("#js_save_og").addClass("notAllow");
					show_dialog_reload("订单礼设置","设置成功");
				}else{
					show_dialog_reload("订单礼设置",obj.msg);
				}
			},
